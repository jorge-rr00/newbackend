...
class FinancialAgent:
    ...
    def analyze(
        ...
        if not rag_data.strip() and not doc_text.strip():
            return "Lo siento, no dispongo de información financiera sobre ese tema en la base de conocimientos."
        
        # Build prompt
        prompt = (
            "Eres un especialista financiero experto. RESPONDE ÚNICAMENTE usando el contexto RAG y el DOCUMENTO del usuario.\n"
